...
namespace AutoLotDAL.EF
{
    public class MyDataInitializer : DropCreateDatabaseAlways<AutoLotEntities>
    {
        protected override void Seed(AutoLotEntities context)
        {
            ...
            {
                new Customer {FirstName = "Андрей", LastName = "Андреев"},
                new Customer {FirstName = "Петр", LastName = "Петров"},
                new Customer {FirstName = "Иван", LastName = "Иванов"},
                new Customer {FirstName = "Федор", LastName = "Федоров"},
            ...
            var cars = new List<Inventory>
            {
                ...
                new Inventory {Make = "Mitsubishi", Color = "Black", PetName = "Andry"},
